...
import magojamillah.wolfplayer.MusicService.MusicBinder;

public class MusicLibrary extends AppCompatActivity implements MediaController.MediaPlayerControl{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MusicLibrary.this, ScanPage.class));
            }
        });
